...
router.get("/record/receivable", customer_transcController.receivable)
router.get("/record/payable", customer_transcController.payable)
router.get("/record/cus-sum", customer_transcController.customerSummary)
