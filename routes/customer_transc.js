...
router.get("/receivable", customer_transcController.receivable)
router.get("/payable", customer_transcController.payable)
router.get("/cus-sum", customer_transcController.customerSummary)
